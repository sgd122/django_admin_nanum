...
class Post(models.Model):
    member = models.ForeignKey(Member, verbose_name='작성자',on_delete=models.SET_NULL,null=True,blank=True)
    category = models.ForeignKey(Category, verbose_name='카테고리',on_delete=models.SET_NULL,null=True,blank=True)
...
class Comment(models.Model):
    ...
    """
    member = models.ForeignKey(Member, verbose_name='작성자',on_delete=models.SET_NULL,null=True,blank=True)
    post = models.ForeignKey(Post, verbose_name='원본글',on_delete=models.SET_NULL,null=True,blank=True)
