    ...
    function html5Upload() {	
    	...
    	if(document.editor_upimage.updir.value)sUploadURL+="?updir="+document.editor_upimage.updir.value;
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		if(document.editor_upimage.updir.value)addUrl ="?updir="+document.editor_upimage.updir.value;	//-- 경로지정
 		
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{ 			
	 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php' + addUrl,	//샘플 URL입니다.
