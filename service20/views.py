    ...
    def list(self, request):
        ...
        for val in queryset:
            data.append({
              ...
              'apl_fr_dt':val.apl_fr_dt,
              'apl_to_dt':val.apl_to_dt,
              'trn_fr_dt':val.trn_fr_dt,
              'trn_to_dt':val.trn_to_dt,
              'tot_apl':val.tot_apl,
              'cnt_apl':val.cnt_apl,
              'status':val.status,
            })
        ...
        return JsonResponse(json.dump(data, outfile),json_dumps_params={'ensure_ascii': True})
        # write list to file
