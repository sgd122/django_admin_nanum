...
class post_user_info_persion_view_Quest(generics.ListAPIView):
    ...
    def list(self, request):
        ...
        query = "select B.std_detl_code_nm,B.rmrk,A.* from service20_mp_ans A, service20_com_cdd B where A.ques_no = B.std_detl_code and B.std_grp_code in (select att_cdh from ms_id = "+key1+") and A.mp_id = '"+key1+"' and apl_id = '"+l_user_id+"'"
